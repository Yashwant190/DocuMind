...
async def process_document(
    ...
    try:
        ...
        # Download file content for processing using stored file_path
        ...
        # Extract text content (simplified - you might want to use proper PDF/DOCX parsers)
        content = file_response.decode("utf-8", errors="ignore")[:3000]
        
        # Generate summary using OpenAI
        response = client.chat.completions.create(
            model="gpt-3.5-turbo",
            messages=[
                {"role": "system", "content": "You are an intelligent document summarizer. Provide comprehensive summaries with key points."},
        ...
        reading_time = f"{max(1, word_count // 250)} min"
        ...
        summary_data = {
            ...
            "key_points": [
                "Document content analyzed and processed",
                "Key insights extracted using AI",
