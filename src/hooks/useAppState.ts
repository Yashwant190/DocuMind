...
export function useAppState() {
  ...
  const generateSummary = (fileName: string): Document['summary'] => {
    ...
    const fullSummary = `This ${title.toLowerCase()} provides comprehensive insights and analysis. The document contains detailed information that has been processed and analyzed to extract key findings and recommendations. Through thorough examination of the content, several important patterns and trends have been identified. The analysis reveals significant insights that can inform decision-making processes and strategic planning initiatives. Key areas of focus include data interpretation, trend analysis, and actionable recommendations based on the findings presented in the document.`;
