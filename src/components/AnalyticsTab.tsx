  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-5xl font-bold text-white mb-3 drop-shadow-[0_0_30px_rgba(255,255,255,1)] float-crazy">
            Analytics Dashboard
          </h1>
          <p className="text-white text-lg drop-shadow-[0_0_20px_rgba(255,255,255,0.8)]">
